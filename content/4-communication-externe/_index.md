+++
pre = '<b>4. </b>'
title = "Communication et données externes"
weight = '500'
draft = false 
+++
...
Ces actions sont appelées **effets de bord** (*side effects*), car elles vont au-delà du simple affichage ; elles affectent le monde extérieur au composant et à l'écosystème de React dans son ensemble.

C’est exactement pour ce genre de situations que React nous fournit la fonction `useEffect`.
