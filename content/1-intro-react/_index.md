...
React est une bibliothèque JavaScript développée par Facebook (Meta) qui permet de créer des interfaces utilisateur dynamiques et réactives. L'objectif principal de React est de simplifier le processus de développement d'applications web complexes en offrant une approche déclarative, ce qui signifie que tu décris l'interface utilisateur en termes de ce que tu veux voir, et React s'occupe de mettre à jour l'interface quand les données changent. Contrairement à la manipulation traditionnelle du DOM, React gère ...

L'une des forces de React réside dans son Virtual DOM, un système qui optimise la mise à jour de l'interface utilisateur en ne rendant que les éléments modifiés, ce qui améliore les performances. De plus, React utilise une syntaxe appelée JSX, qui permet de combiner du code JavaScript et HTML de manière fluide, rendant le développement plus intuitif.

Grâce à sa popularité et à son vaste écosystème, React est largement adopté par les développeurs pour créer des applications web dynamiques, des sites à page unique (SPA) et même des applications mobiles avec React Native.



Enfin, dans cette section, nous allons apprendre comment créer une page statique avec React.
...
+ Un framework peut utiliser des librairies 
...
L'une des idées principales derrière React est l'utilisation de **composants**. Un composant dans React est une unité autonome qui qui gère son propre état et peut être réutilisée pour construire des interfaces complexes de manière modulaire et efficace.

##### Exemple de composant simple
Imaginons que tu veuilles afficher un message personnalisé dans ton application. Voici comment tu pourrais créer un composant React pour cela :
...
```
Dans cet exemple, **`Message`** est un composant simple qui prend une **prop** `name` et l'affiche dans un élément `<h1>`.

##### Exemple de composant avec plusieurs sous-composants
Tu peux aussi combiner plusieurs composants pour créer des interfaces plus complexes. Par exemple, un composant parent `UserCard` qui utilise un composant `UserProfile` :
...
Une des raisons pour lesquelles React est si performant est son utilisation du **Virtual DOM**. Le **Virtual DOM** est une représentation en mémoire du DOM réel. Lorsque l'état des composants change, React met à jour d'abord le Virtual DOM, puis compare cette version avec l'ancien DOM pour déterminer les différences, et enfin, applique uniquement les changements nécessaires au DOM réel. Cela permet de minimiser les manipulations du DOM et d'optimiser les performances.

> **Note importante :** Le Virtual DOM est un des principes clés qui rendent React rapide, même avec des interfaces complexes.

---

### Lancement d'un projet React local
...
React adopte une approche déclarative qui simplifie le développement d'applications web complexes en s'appuyant sur sa librairie pour effectuer les tâches manuelles et fastidieuses à notre place.
...
### Exercice dirigé : page HTML en composants JSX 
L'objectif de cet exercice est de recréer cette page web en utilisant React et des **composants JSX** bien structurés. Vous devrez décomposer le code HTML fourni en plusieurs composants réutilisables et les organiser dans des fichiers distincts.
...
<body>
  ...
  <main>
    ...
    <div class="list-item">
      <img src="data:image/jpeg;base64," alt="Technologie évolutive">
      <div>
        <h3>Les technologies évoluent rapidement, et ça me garde à l'affût.</h3>
        <p>Le secteur est en constante évolution, ce qui me pousse à apprendre et à rester à jour avec les nouvelles tendances.</p>
      </div>
    </div>
...
Vous pouvez tenter d'ajouter des fonctionnalités supplémentaires, comme rendre les composants de votre liste dynamiques, pour explorer davantage les possibilités de React.

Les éléments de votre liste partagent la même structure (image, titre, description), seules les informations varient. Comment pourriez-vous utiliser un seul composant ListItem pour afficher plusieurs éléments avec des contenus différents ?

Nous allons explorer cette idée dans notre prochain module, où nous apprendrons à utiliser les props dans React. Les props permettent de rendre vos composants dynamiques et réutilisables, en passant des données spécifiques à chaque instance du composant. Vous verrez comment cela simplifie votre code et améliore sa maintenabilité.

> **Astuce finale :** En utilisant des composants et des props, ton code deviendra modulaire, réutilisable et plus facile à maintenir.
